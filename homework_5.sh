...
kallisto quant -t 6 -b 100 -i ${OUTDIR}/GCF_000005845.2_ASM584v2_cds.fa.idx -o ${KALLISTO}/SRR5344681 /work/gene8940/instructor_data/SRR5344681_1.fastq.gz /work/gene8940/instructor_data/SRR5344681_2.fastq.gz
kallisto quant -t 6 -b 100 -i ${OUTDIR}/GCF_000005845.2_ASM584v2_cds.fa.idx -o ${KALLISTO}/SRR5344682 /work/gene8940/instructor_data/SRR5344682_1.fastq.gz /work/gene8940/instructor_data/SRR5344682_2.fastq.gz
kallisto quant -t 6 -b 100 -i ${OUTDIR}/GCF_000005845.2_ASM584v2_cds.fa.idx -o ${KALLISTO}/SRR5344683 /work/gene8940/instructor_data/SRR5344683_1.fastq.gz /work/gene8940/instructor_data/SRR5344683_2.fastq.gz
kallisto quant -t 6 -b 100 -i ${OUTDIR}/GCF_000005845.2_ASM584v2_cds.fa.idx -o ${KALLISTO}/SRR5344684 /work/gene8940/instructor_data/SRR5344684_1.fastq.gz /work/gene8940/instructor_data/SRR5344684_2.fastq.gz
